...
public class FuncionarioController {
    ...
    public Optional<FuncionarioModel> buscarPorCd(@PathVariable Integer cdFuncionario) {
        return funcionarioService.findById(cdFuncionario);
    }
    ...
    @GetMapping("/usuarios/nome/{nmUsuario}")
    public Optional<FuncionarioModel> buscarUsuarioPorNm(@PathVariable String nmUsuario) {
        return funcionarioService.findByUsuarioNmUsuario(nmUsuario);
    }


    @GetMapping("/usuarios/id/{cdUsuario}")
